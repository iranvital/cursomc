...
import com.iranvital.cursomc.domain.ItemPedido;
import com.iranvital.cursomc.domain.Pagamento;
import com.iranvital.cursomc.domain.PagamentoComBoleto;
import com.iranvital.cursomc.domain.PagamentoComCartao;
import com.iranvital.cursomc.domain.Pedido;
import com.iranvital.cursomc.domain.Produto;
import com.iranvital.cursomc.domain.enums.EstadoPagamento;
import com.iranvital.cursomc.domain.enums.Perfil;
...
import com.iranvital.cursomc.repositories.ItemPedidoRepository;
import com.iranvital.cursomc.repositories.PagamentoRepository;
import com.iranvital.cursomc.repositories.PedidoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 =  new Cliente(null, "Maria Silva", "maria@gmail.com", "77387473668", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("3232-3232", "9898-6565"));
		
		Cliente cli2 =  new Cliente(null, "Pedro Paulo", "iranprogramador@gmail.com", "41781318182", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("1111-3232", "99999-6565"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floreano", "210", null, "Centro", "22277018", cli2, c2);
